...
CREATE TABLE IF NOT EXISTS manual_orders (
    ...
    -- ------------------------------------------------------------------
    -- What the VENUE said it did (v40 PLACEHOLDER, 2026-09-11).
    -- ------------------------------------------------------------------
    --
    -- **!! PLACEHOLDER SCHEMA VERSION !!** `lane-b-window-index` holds 40 as
    -- a placeholder too and is unmerged, so the 40 above is a marker, not an
    -- allocation, and exactly one of the two lanes renumbers.
    -- `db.SCHEMA_VERSION`, the `_MIGRATIONS` key and this line are ONE number
    -- and are re-taken together at merge, after `git fetch`. See
    -- `docs/adr/README.md`.
    --
