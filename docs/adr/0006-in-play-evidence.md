# Evidence for ADR 0006 — in-play measurements, 2026-08-08

**The decision this was written to support was REJECTED (Joe, 2026-08-08), and
these measurements were not.** The scope question stays open; see
`docs/adr/0006-in-play-scope.md`. Kept here rather than in `tasks/inbox/` —
which is transient by ADR 0003 — because every number below came from a live
walk of the exchange, and re-deriving them costs real API work.
