# 0142 — The ticket says how deep he already is

Date: 2026-09-11. Written by lane A with no ordinal; the number was taken at
the merge commit after `git fetch`, per `docs/adr/README.md`.
