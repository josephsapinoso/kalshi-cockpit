# ADR 0101 — `/bets` separates the kinds, states its own first day, and says what is open in words it can keep

**Status:** Accepted; ordinal 0101 taken at the merge boundary
(`docs/adr/README.md`).
**Date:** 2026-09-03.
