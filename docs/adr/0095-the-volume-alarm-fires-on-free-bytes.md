# ADR 0095 — The volume alarm fires on free bytes, not on a projected date

- **Status:** Accepted. Numbered 0095 at merge, after `git fetch`.
- **Date:** 2026-09-01
- **Related:** `docs/measurements/2026-09-01-the-volume-clock.md` (the
  ...
  `0096-fair-prices-is-downsampled-to-daily-behind-a-flag.md`, which is the
