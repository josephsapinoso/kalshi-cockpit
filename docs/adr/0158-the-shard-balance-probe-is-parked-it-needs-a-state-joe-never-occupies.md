# 0158 — The shard-balance probe is parked, because it needs an account state Joe never occupies

**Status:** accepted 2026-09-15 (written as a lane draft; the ordinal was
assigned on `main` at merge). Accepted as a **park of a queue item**, and as
nothing else. The question it would settle —
