# DRAFT — Sized to zero is its own state, and NO EDGE means what its caption says

**Status:** Draft — the ordinal is taken in the merge commit, after
`git fetch`, per `docs/adr/README.md`. Do not cite this file by number.
**Date:** 2026-09-03.
