# Archive - `tasks/NEXT.md` entries moved out on 2026-09-18

**Verbatim.** The four 2026-09-17, six 2026-09-16 and four 2026-09-15
entries that were still in `tasks/NEXT.md` when it reached 234,750 bytes,
**89.6%** of the 262,144-byte ceiling - the first split taken from *past*
the ~90% trigger rather than under it, and the highest percentage any cut
has been taken at since the 2026-08-27 miss. Cut on a date boundary:
everything 2026-09-17 and earlier moved, so the four 2026-09-18 entries
stay together and no single day is split across two files. Left
70,292 bytes - **26.8%**.

The bytes below this header hash identically to the bytes removed from
`tasks/NEXT.md`: `e2eb3b8abb93cb345b90d5134f0e1d0f`.
