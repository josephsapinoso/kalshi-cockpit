# NEXT.md archive — sessions through 2026-08-14

**This file is history, not a checklist. Nothing in it is waiting on anybody.**
It holds every session note from `tasks/NEXT.md` between 2026-08-08 and
2026-08-14, moved here on 2026-08-15 when the live file reached 6,229 lines and
stopped being readable. The live checklist is `tasks/NEXT.md`; read that first
and come here only to recover the reasoning behind a decision.

**Read anything below with the date in mind.** These sections were written as
running commentary and later sections routinely correct earlier ones — several
say so in their own headings. Where a claim here disagrees with `CLAUDE.md`,
`docs/adr/`, or the live `NEXT.md`, those win.

**One number in here is known to be wrong.** The closing section, "The honest
status", states the taker break-even bar as ~52.00%. That figure was corrected
to **51.75%** on 2026-08-14 when the fee hedge was retired; see
`docs/adr/0028-the-fee-hedge-is-retired-and-the-grid-is-deci-cent.md`. The
sentence is left as written rather than edited, because this file is a record
