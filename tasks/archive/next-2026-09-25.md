# Archive - `tasks/NEXT.md` entries moved out on 2026-09-25

**Verbatim.** The six 2026-09-22, three 2026-09-21, two 2026-09-20, one
2026-09-19 and six 2026-09-18 entries that were still in `tasks/NEXT.md`
when it reached 234,272 bytes, **89.4%** of the 262,144-byte ceiling. Cut
on a date boundary: everything 2026-09-22 and earlier moved, so the four
2026-09-23 entries stay together and no single day is split across two
files. Left 42,687 bytes before the index - **16.3%**.

The bytes below this header hash identically to the bytes removed from
`tasks/NEXT.md`: `3958e58d926207d3380cfa928697cdb7`.
