# Archive — lessons from `tasks/lessons.md`, split 2026-09-18

**Verbatim.** Every lesson dated 2026-09-15 and earlier that was still living in
`tasks/lessons.md` on 2026-09-18, moved here unchanged when that file stood at
225,816 bytes (86.1% of the 262,144-byte ceiling). 51 lessons across 5 dates.
The bytes removed hash to `06715950408225f41848e30be11bca05`; their index lines moved in the same edit and
now point here. The split is recorded in `lessons-split-log.md`.
