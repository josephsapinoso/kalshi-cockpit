...
| Venue structure (`KXMVE` combos) | **exit-only problem**: no YES bid on 40/40 books ever read (entry: 33/40 had a resting NO bid) | [0012 §5](docs/adr/0012-a-combo-price-is-read-not-created.md) |
