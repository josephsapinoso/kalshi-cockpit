  ...
  return (
    <Shell>
      ...
      >
        ...
        {/* **Beneath the banner, behind a tap since 2026-08-22.** The banner
            says whether this instant is usable; the timetable and the refresh
            apparatus answer follow-up questions ("when today?", "can I buy a
            fresher price?") that a reader asks sometimes — while every load
            paid their full height on the way to the cards. The review
            measured the first card ~1,300px down at 390px with these open.
            Both stay in the banner's block, in the same DOM order, so the
            phone's reading order and the xl rail are unchanged; only their
        ...
        {actionable && (
          <details className="mt-4">
            ...
            <WindowSchedule window={actionable} />
          </details>
        )}
        ...
        {/* **Directly below the cards since 2026-08-22 (it sat above them).**
            What the edge-finder was worth when it was measured against
            Kalshi's own close. Above the cards it was a disclaimer every load
            scrolled past on the way to a price; below them it is the verdict
            on what was just read, and the review's rule — measurement
            post-mortems do not outrank tonight's games — applies here the
            same way it does on the landing screen. */}
        <div className="mt-8">
